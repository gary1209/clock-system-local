...
<head>
  ...
  <script type="text/javascript" src="https://cdn.datatables.net/v/bs4-4.0.0/jq-3.2.1/dt-1.10.16/datatables.js"></script>
          ...
          <?php
                ...
                if (mysqli_num_rows($result) > 0){
                  while ($row = mysqli_fetch_array($result)) {
                    ...
                    echo "<td><a href='".$row['photo_path']."'><img src='images/link_logo.png' style='width: 25px;'/></a></td>";
